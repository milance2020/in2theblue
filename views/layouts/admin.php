    ...
    <aside class="sidebar">
        ...
        <div id="links-admin">
          <ul>
            ...
            <li><a href="<?= appUrl('shop') ?>">Prodavnica</a></li>
            ...
            <li><a href="index.php?page=adminPanel&view=siteContent">Uredi sadržaj</a></li>
            <hr>
            ...
            <?php if ($page !== 'adminPanel'): ?>
                <a href="<?= appUrl('login') ?>">Prijava</a>
            <?php else: ?>
                <a href="<?= logoutUrl() ?>" id="logout-admin">Odjava</a>
            <?php endif; ?>
            </ul>
        </div>
